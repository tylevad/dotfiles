...
"
" Last Change: 2020 May 5; added custom highlighting (Ty Levad)
" ----------------------------------------------------------------------------
...
syn region rubyBlockParameterList matchgroup=rubyBlockDelim start="\%(\%(\<do\>\|{\)\s*\)\@<=|" end="|" oneline display contains=rubyBlockParameter,rubySpecialOperator
...
hi def link rubyBlockDelim             Delimiter
...
hi def link rubySpecialOperator        Special
...
hi def link rubyStringDelimiter        Special
hi def link rubyArrayDelimiter         Delimiter
hi def link rubyCurlyBlockDelimiter    Delimiter
